...
def achados_from_texto(partes):
    ...
    achados = {
        ...
        "destruicao_cortical": _tem(texto, "destruicao cortical", "corticais perfuradas", "perfuracao focal", "perfuração focal"),
        "invasao_partes_moles": _tem(texto, "invasao de partes moles"),
